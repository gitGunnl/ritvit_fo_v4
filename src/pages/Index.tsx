    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-8 animate-fade-up transform transition-transform duration-300 group-hover:translate-y-4">
          ...
          <div className="group relative max-w-2xl mx-auto text-xl mb-8">
            <p className="hidden md:block opacity-0 group-hover:opacity-100 transition-all duration-300 text-gray-600 dark:text-gray-300 mb-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 animate-fade-up transform transition-transform duration-300 group-hover:-translate-y-4">
