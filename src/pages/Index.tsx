      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <div className="group relative">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-8 transition-all duration-300 transform group-hover:translate-y-12">
              Steðga at spilla tíð upp á uppgávur, sum ritvit kann gera fyri teg!
            </h1>
            <div className="relative max-w-2xl mx-auto text-xl mb-8">
              <p className="text-gray-600 dark:text-gray-300 transition-all duration-300 transform group-hover:-translate-y-12">
                🚀 <strong>Lær at brúka ritvit upp á fáar dagar – og fá meira tíð til tað, sum  
                veruliga hevur týdning.</strong>
              </p>
              <div className="hidden md:block absolute w-full opacity-0 group-hover:opacity-100 transition-all duration-300">
