    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="glass-card p-8 md:p-12 relative overflow-hidden bg-black/30 border border-white/10 hover:border-purple-500/30 transition-all">
            <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-indigo-400 text-transparent bg-clip-text">
              Byrja við tí týdningarmesta: Lær at brúka ChatGPT
            </h2>
            {/* Course Card */}
            <div className="glass-card overflow-hidden flex flex-col md:flex-row mb-8 bg-black/20 border border-purple-500/20">
              {/* Course Screenshot */}
