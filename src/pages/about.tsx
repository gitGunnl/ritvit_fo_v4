      ...
      <div className="py-20 bg-background">
        <div className="container px-4 mx-auto">
          ...
          <div className="text-center mb-20 animate-fade-down">
            <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">About Us</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            <Card className="p-8 glass-card hover-lift animate-fade-up hover:shadow-purple-200/50 hover:border-purple-200">
            ...
            <Card className="p-8 glass-card hover-lift animate-fade-up hover:shadow-indigo-200/50 hover:border-indigo-200">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-12 bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Our Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: <Award className="w-12 h-12 text-violet-600 mb-4" />,
                  title: "Excellence",
                ...
                {
                  icon: <Heart className="w-12 h-12 text-violet-600 mb-4" />,
                  title: "Integrity",
                ...
                <Card 
                  key={index} 
                  className="p-6 text-center glass-card hover-lift animate-fade-up hover:shadow-purple-200/50 hover:border-purple-200"
