    ...
    <div className="min-h-screen bg-background text-gray-900 dark:text-white">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 animate-fade-up">
            Vi bringer AI til Færøerne – og videre
          </h2>
          <p className="text-xl max-w-3xl mx-auto leading-relaxed text-muted-foreground animate-fade-up">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="glass-card p-8 rounded-lg shadow-lg animate-fade-up">
            <p className="text-lg mb-4">
              Vi startede <strong>Tøkni Tænastan</strong> af én simpel grund:
            </p>
            <p className="text-lg mb-4">
              <strong>
                At hjælpe færøske virksomheder med at udnytte AI – uden bøvl, uden hype,
                uden unødvendigt teknisk snak.
              </strong>
            </p>
            <p className="text-lg mb-4">
              Sandheden? <strong>AI er her allerede.</strong> Og dem, der lærer at bruge det
              først, får et stort forspring.
            </p>
            <p className="text-lg">
              Derfor gør vi AI <strong>simpelt, brugbart og praktisk</strong> – så virksomheder
              kan <strong>spare tid, arbejde smartere og få tingene gjort hurtigere</strong>.
            </p>
            <p className="text-lg mt-4">
              🚀 <strong>Ingen teknisk viden nødvendig. Ingen dyre konsulenter. Bare AI, der
              fungerer.</strong>
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-white/50 dark:bg-black/20">
        <div className="container mx-auto px-4">
          ...
          <div className="glass-card p-8 rounded-lg shadow-lg animate-fade-up">
            ...
            <p className="text-lg mb-4">
              Jeg har altid været besat af <strong>ny teknologi</strong> – alt det, der ændrer
              måden, vi arbejder og lever på.
            </p>
            <p className="text-lg mb-4">
            ...
            <p className="text-lg mt-4">
              ...
              <strong>automatisere opgaver, effektivisere deres arbejde og udnytte AI’s
              fulde kraft</strong> – så de kan fokusere på det, der virkelig betyder noget.
            </p>
          </div>
        </div>
      </section>

      {/* Vores mission: AI for alle */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="glass-card p-8 rounded-lg shadow-lg animate-fade-up">
            <h2 className="text-3xl font-bold mb-4">Vores mission: AI for alle</h2>
            <p className="text-lg mb-4">
              AI er ikke kun for <strong>Silicon Valley</strong>. Det er for din virksomhed. Dit
              team. Din hverdag.
            </p>
            <p className="text-lg mb-4">
            ...
            <ul className="list-disc ml-6 text-lg mb-4">
              ...
              <li>
                ✅ <strong>Hjælpe virksomheder med at spare tid og ressourcer</strong> – uden at
                ansætte ekstra personale.
              </li>
              <li>
            ...
            <p className="text-lg">
              Vi sælger ikke bare "AI-rådgivning". Vi{" "}
              <strong>træner, implementerer og bygger</strong> løsninger, der giver{" "}
              <strong>konkrete resultater</strong>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white/50 dark:bg-black/20">
        <div className="container mx-auto px-4">
          <div className="glass-card p-8 rounded-lg shadow-lg animate-fade-up">
            ...
            <p className="text-lg mb-4">
              AI er <strong>overalt</strong>, men de fleste virksomheder kæmper med de samme
              udfordringer:
            </p>
            <ul className="list-disc ml-6 text-lg mb-4">
              <li>
            ...
            <ul className="list-disc ml-6 text-lg">
              <li>
                💡 <strong>Vi taler dit sprog.</strong> Ingen kompliceret AI-snak – kun klar, brugbar
                vejledning.
              </li>
              <li>
                🚀 <strong>Vi fokuserer på små, hurtige sejre.</strong> AI behøver ikke være et stort
                projekt. Vi starter med én ting, du kan automatisere nu – så du ser resultater med det
                samme.
              </li>
              <li>
                🇫🇴 <strong>Vi forstår det færøske marked.</strong> Internationale AI-firmaer kan give
                generelle råd, men vi kender <strong>de faktiske udfordringer</strong> og{" "}
                <strong>den unikke færøske arbejdskultur</strong>.
              </li>
              <li>
                🤖 <strong>Vi bruger selv AI hver dag.</strong> Det her er ikke teori. Vi har testet,
                bygget og optimeret AI-løsninger, så vi ved præcis, hvad der virker – og hvad der ikke
                gør.
              </li>
            </ul>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="glass-card p-8 rounded-lg shadow-lg animate-fade-up">
            ...
            <p className="text-lg mb-4">
              Vi hjælper ikke bare virksomheder <strong>i dag</strong> – vi bygger{" "}
              <strong>for fremtiden</strong>.
            </p>
            <ul className="list-disc ml-6 text-lg mb-4">
              <li>
      ...
      {/* Call-to-Action: Lad os tage en snak */}
      <section className="py-16 bg-gradient-to-br from-purple-600/20 to-indigo-600/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <ul className="list-disc ml-6 text-lg mb-8 animate-fade-up">
            <li>
              ✅ Stoppe med at spilde tid på gentagne opgaver?
            </li>
            <li>
              ✅ Få AI til at hjælpe dig med e-mails, rapporter og oversættelser?
            </li>
            <li>
              ✅ Komme foran dine konkurrenter?
            </li>
          </ul>
          <p className="text-lg mb-8 animate-fade-up">
